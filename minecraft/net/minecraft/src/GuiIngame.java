...
public class GuiIngame extends Gui
{
    ...
    {
    xray_mode++;
    if(xray_mode > 6) xray_mode = 0;
    mc.renderGlobal.loadRenderers();
    }
    if(checkKey(Keyboard.KEY_LEFT))
    {
    xray_mode--;
    if(xray_mode < 0) xray_mode = 6;
    mc.renderGlobal.loadRenderers();
    }
    ...
    mc.renderGlobal.loadRenderers();
			...
			if(bright)
				{	
					var8.drawString("O: Bright", 2, 22, 0x00ff00);
				}else
				{
					var8.drawString("O: Bright", 2, 22, 0xffffff);
				}
			...
			if(insta)
				{	
					var8.drawString("I: Instamine", 2, 12, 0x00ff00);
				}else
				{
					var8.drawString("I: Instamine", 2, 12, 0xffffff);
				}
				
				var8.drawString(getXrayString(), 5, var5.getScaledHeight() - 16, 0xFF); 
				var8.drawString("Luna: Nightmare Moon Edition", 2, 2, 0xffffff);
		}
	...
	public static int xray_mode = 6;
    public static int xray_opac = 90;
...
public static int[][] idList =  {
    ...
    /** GOLD  [1] **/ { 14, 41 }, 
    /** IRON  [2] **/ { 15, 42 }, 
    /** VALUABLE [3] **/ { 41, 42, 57, 54, 22, 84, 46, 86, 91 },
    /** CLUSTER  [4] **/ { 56, 57, 14, 41, 15, 42, 54, 16, 73, 74, 33, 34, 84, 91, 22, 21, 29, 48, 86, 48, 46, 120 },
    /** CHEST  [5] **/ {54 },
    /** NOTHING [6 **/ { }
  };

public static String getXrayString() {
  String s = "";
  switch(xray_mode) {
    case 0:
    s = "\247bDiamond";
